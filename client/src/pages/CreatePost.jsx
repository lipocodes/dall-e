...
const CreatePost = () => {
  ...
  const generateImage = async()=>{
    if(form.prompt){
      ...
      }catch(err){alert(err); } finally{setGeneratingImg(false);}
    }else{
    ...
    <section className='max-w-7xl mx-auto'>
      ...
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        ...
        <div className='mt-10'>
          ...
          <button className='mt-3 text-white bg-[#6469ff] font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center' onClick={handleSubmit} type="button">
